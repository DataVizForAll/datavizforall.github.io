...
**School Based Health Centers:** Melanie Wilde-Lane (Executive Director) and Isabel Gonillo (Program Assistant) from the [Connecticut Association for School Based Health Centers](https://ctschoolhealth.org). Their nonprofit organization advocates for medical, dental, and mental health services that are provided in over 300 public schools across the state. They have asked us to create data stories to help them answer questions such as: How does access to these health centers vary by family income and school district funding? How does free preventive care improve long-term health outcomes and reduce government costs for emergency room visits?
...
Read before class: United Way of Central and Northeastern CT, "2023 Alice Report: Regional Catchment" (2-page summary), <https://unitedwayinc.org/publications/2023-alice-report/>. Skim the longer report as needed.
  ...
  - How should these 2021 numbers be adjusted for 2024?
  - What is the current minimum wage in CT versus Federal minimum wage, and how do these differ for tipped restaurant workers?
...
- Before class, read background and write questions to prepare for today's meeting:
  ...
  - [USA Resale Procedure documents, Summer 2024](https://drive.google.com/file/d/1Q5iw_4cguwXPOESftpllB0noBcP1XSSF/view?usp=sharing)
- Assign random pairs to [Build Stage 1: Listen, Find & Question Data](https://docs.google.com/document/d/18k8YfQh3rqA0-zN_BDF67Md_T_AUu4sJ7IcyJaHqnis/edit), Paste the link to your co-authored starter Google Doc on our Build 1 page and *share it so that anyone can comment* before you leave the room. Due on Sun Sept 22nd at 9pm (same deadline as the quiz, so plan ahead), worth 5 points.
...
### Wed Oct 9
- Brief review of [Build 3 compiled data](https://docs.google.com/spreadsheets/d/1KzoCc8Xk0MTqJRNPzmEtFYTiqRGTkSiWXJecaIN4jIo/edit?gid=540050657#gid=540050657)
...
- In-class workshop time before [Build 6: Draft Your Data Story](https://docs.google.com/document/d/1Qj9pXfcAQKSyLKPJN1CAadRTabxELfydf8i-j07wEtY/) is **now due Tues Nov 19th 9pm**
...
- Last call to register for Outreach Opportunity #3 - see details above
...
- Assign [Build 7: Data Stories for Community Partners](https://docs.google.com/document/d/15Nmf2aFVG3b3UskIEefNcDJlWala9Sm2OSd-E-YBcx4/). Improve your draft based on instructor and peer feedback, and migrate all content from Google Doc to GitHub Pages format. Insert link to your published GitHub Pages template on our Build 7 doc. Due Monday Dec 2nd by 9pm (the first day back from Thanksgiving break) for instructor to forward to community partners for non-graded comments, worth participation credit.
...
- **More learning resources** for Build 7
  - [Notes: How much wealth does 30 years of homeownership generate compared to renting?](https://docs.google.com/document/d/1nv0Kt_njJw2XZB5AeuMi9N3uRDlvjXNg9LQ2nEcfvb4/)
  - [How to show price growth in stacked column chart](https://docs.google.com/spreadsheets/d/1zT9FSFe0bxBhG-jN5-hLEK-SBaNNP9fDP4sL05RTs3M/)
...
### Mon Dec 2
- In class: Respond to [supplemental student feedback questions on what helped you learn](https://docs.google.com/document/d/1nXbJaHGr_ZYCSZw5r8ujX7qXLV2dYFu1rpn7t05Isdc). In addition, please fill out the College's standard online evaluation form when available.
- Finish [Build 7: Data Stories for Community Partners](https://docs.google.com/document/d/15Nmf2aFVG3b3UskIEefNcDJlWala9Sm2OSd-E-YBcx4/) by Monday Dec 2nd at 9pm. Migrate all content from Google Doc to your GitHub Pages data story template. Insert your title and link on the page above before leaving the room. Rehearse a 1-minute overview of highlights to deliver to community partners **who will join us in our classroom** on Wed Dec 4th to offer non-graded comments. Worth participation credit.
- Assign [Build 8: Revise and Finalize Data story for guest experts](https://docs.google.com/document/d/1YeMnPZiMhI4gGigsZK35K5nwa3cn3IBFF9dNaAbYi7g/edit?tab=t.0). After feedback from our community partners, finish any revisions to your Build 7 data story by **Friday Dec 6th at 12 noon**. There are **no extensions** because guest experts need time to read your work. **Do not paste your link in Build 8**. Instead, the instructor will make a "frozen" copy of your most current revisions to Build 7, republish it on the public [Partners and Projects page](https://datavizforall.org/partners-projects/), and paste those links in Build 8 to send to our guest experts to read before your presentations. Rehearse your 2-minute overview of highlights for guest experts, and prepare for Q&A. Worth 10 points, scored by guest experts.
