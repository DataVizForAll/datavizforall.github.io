...
- TA Nellie shares [DataViz XLOOKUP Practice to help prepare for the quiz](https://docs.google.com/spreadsheets/d/1NFCoArK4VQg7UZywthSzf46rGC3eqNbgB0UwqgPX3bk/edit?gid=0#gid=0) -- insert formulas to match and fill all three empty columns on the first sheet, using data from other sheets
...
- **NEW** [Demo: Change #NA to blanks for pivot table calculations](https://docs.google.com/spreadsheets/d/1HlvCgSkGu2hcg6VDoWHdGcttK9xUVEiHb6rkW1C6CIQ/edit?gid=0#gid=0)
